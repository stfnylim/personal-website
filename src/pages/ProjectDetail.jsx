...
export default function ProjectDetail() {
  ...
  // The header (title, tags, meta) is always visible.
  // Only the content sections are gated behind the password.
  ...
  return (
    <main className={styles.main}>
      ...
      {/* ── Content — optionally password-gated ── */}
      {project.passwordHash ? (
        <PasswordGate projectId={project.id} passwordHash={project.passwordHash}>
          {contentSections}
        </PasswordGate>
      ) : contentSections}
    </main>
